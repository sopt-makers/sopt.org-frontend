...
export const infoMap: Record<Part, { info: string; fit: string[] }> = {
  ...
  [Part.IOS]: {
    info: 'Swift와 UI Kit를 이용해서 iOS 앱 서비스를 만들 수 있는 능력을 기를 수 있습니다. iOS가 처음인 분들을 위한 왕초보 스터디와 보충 세미나, 그리고 실력적 도약을 위한 심화 세미나까지. 자신의 성장을 위해 열정적으로 도전하는 사람들과 함께 활동에 필요한 부분들을 학습할 수 있습니다.',
    fit: [
