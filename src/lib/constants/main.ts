...
export const INTRO_CONTENT_LIST = [
  {
    ...
    title: '포기하지 않고\n끝까지 나아가는 사람',
    detail:
      '솝트는 쉽게 포기하지 않습니다.\n어떤 어려움이 있더라도 끝까지 고민하고, 끝까지 해내며 앞으로 나아갑니다. 서로의 의지는 또 다른 의지가 되어 우리를 계속 움직이게 합니다.',
  ...
  },
  {
    ...
    detail:
      '솝트에서는 아이디어를 말로만 남겨두지 않습니다.\n생각한 것을 직접 만들고, 시도하고, 부딪히며 현실로 만들어냅니다.\n실행을 통해 우리는 더 빠르게 배우고 성장합니다.',
  ...
  },
  {
    ...
    title: '함께일 때 더\n성장할 수 있는 사람',
    detail:
      '솝트에서는 200여명의 활동 회원과 \n4000여명의 명예 회원들이 서로의 경험과 역량을 연결하며 함께 문제를 해결합니다.\n우리는 함께이기에 더 멀리 나아갈 수 있다고 믿습니다.',
