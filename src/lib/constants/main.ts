  ...
  [Part.PLAN]: [
    {
      content: '린스타트업 기초',
      ...yellowStyle,
      desktop: { top: '92.97rem', right: '11.34vw' },
      tablet: { top: '258rem', right: '8.59vw' },
      mobile: { top: '148rem', right: '10.74vw' },
    },
    {
      content: 'IT 프로덕트 기획',
      ...indigoStyle,
      desktop: { top: '157.13rem', right: '18.39vw' },
      tablet: { top: '297rem', right: '29.03vw' },
      mobile: { top: '177rem', right: '27.1vw' },
    },
    {
      content: '전반적인 매니징',
      ...blueStyle,
      desktop: { top: '282.28rem', right: '12.55vw' },
      tablet: { top: '383rem', right: '11.06vw' },
      mobile: { top: '223rem', right: '12.86vw' },
    },
  ],
  [Part.DESIGN]: [
    {
      content: '피그마와 같은 협업툴',
      ...skyStyle,
      desktop: { top: '92.97rem', right: '9.15vw' },
      tablet: { top: '259rem', right: '5.72vw' },
      mobile: { top: '149.28rem', right: '5.98vw' },
    },
    {
      content: 'UX/UI 전반적 과정',
      ...indigoStyle,
      desktop: { top: '157.13rem', right: '17.09vw' },
      tablet: { top: '306rem', right: '20.18vw' },
      mobile: { top: '176.14rem', right: '20.9vw' },
    },
    {
      content: '새로운 프로덕트',
      ...blueStyle,
      desktop: { top: '282.28rem', right: '12.55vw' },
      tablet: { top: '386rem', right: '11.97vw' },
      mobile: { top: '222.02rem', right: '12.38vw' },
    },
  ],
  [Part.ANDROID]: [
    {
      content: 'UI 구현 기초/심화',
      ...yellowStyle,
      desktop: { top: '117.6rem', right: '6.16vw' },
      tablet: { top: '305rem', right: '6.38vw' },
      mobile: { top: '174rem', right: '6.07vw' },
    },
    {
      content: 'Kotlin 언어 활용',
      ...indigoStyle,
      desktop: { top: '96rem', right: 'calc(115rem + 10vw)' },
      tablet: { top: '289rem', right: 'calc(110rem + 10.15vw)' },
      mobile: { top: '165rem', right: 'calc(50rem + 14.06vw)' },
    },
    {
      content: '서버 통신',
      ...blueStyle,
      desktop: { top: '232rem', right: '7.34vw' },
      tablet: { top: '372rem', right: '8.85vw' },
      mobile: { top: '210rem', right: '10.74vw' },
    },
    {
      content: '페어 프로그래밍',
      ...greenStyle,
      desktop: { top: '278.38rem', right: 'calc(50rem + 10vw)' },
      tablet: { top: '378rem', right: '28.77vw' },
      mobile: { top: '213rem', right: '29.43vw' },
    },
  ],
  [Part.IOS]: [
    {
      content: 'iOS 앱 서비스',
      ...indigoStyle,
      desktop: { top: '82.31rem', right: 'calc(102rem + 10vw)' },
      tablet: { top: '285rem', right: 'calc(100rem + 9.11vw)' },
      mobile: { top: '178rem', right: 'calc(50rem + 12vw)' },
    },
    {
      content: 'Swift와 UI Kit',
      ...yellowStyle,
      desktop: { top: '117.6rem', right: '6.72vw' },
      tablet: { top: '314rem', right: '6.38vw' },
      mobile: { top: '188rem', right: '6.07vw' },
    },
    {
      content: '보충 및 심화 세미나',
      backgroundColor: '#D65438',
      color: '#fff',
      desktop: { top: '223.74rem', right: 'calc(33rem + 5vw)' },
      tablet: { top: '390rem', right: '16.79vw' },
      mobile: { top: '235rem', right: '15.42vw' },
    },
    {
      content: '왕초보 스터디',
      ...blueStyle,
      desktop: { top: '275.88rem', right: '19.02vw' },
      tablet: { top: '350rem', right: '33.97vw' },
      mobile: { top: '212rem', right: '38.78vw' },
    },
  ],
  [Part.WEB]: [
    {
      content: '웹 서비스 개발',
      ...yellowStyle,
      desktop: { top: '92.97rem', right: '12.06vw' },
      tablet: { top: '301rem', right: '10.93vw' },
      mobile: { top: '170rem', right: '13.08vw' },
    },
    {
      content: '기초부터 심화까지',
      ...indigoStyle,
      desktop: { top: '157.13rem', right: '17.66vw' },
      tablet: { top: '354rem', right: '27.47vw' },
      mobile: { top: '200rem', right: '29vw' },
    },
    {
      content: 'UI구현과 서버 통신',
      ...skyStyle,
      desktop: { top: '282.28rem', right: '11.25vw' },
      tablet: { top: '382rem', right: '8.33vw' },
      mobile: { top: '215rem', right: '10.74vw' },
    },
  ],
  [Part.SERVER]: [
    {
      ...
      ...greenStyle,
      desktop: { top: '92.97rem', right: '8.16vw' },
      tablet: { top: '301rem', right: '10.10vw' },
      mobile: { top: '178rem', right: '15.42vw' },
    },
    {
      content: '관계형 데이터베이스',
      ...indigoStyle,
      desktop: { top: '157.13rem', right: 'calc(30rem + 3.69vw)' },
      tablet: { top: '346rem', right: '4.2vw' },
      mobile: { top: '203rem', right: '8.4vw' },
    },
    {
      content: 'AWS 기반',
      ...skyStyle,
      desktop: { top: '192rem', right: 'calc(110rem + 15.1vw)' },
      tablet: { top: '323rem', right: 'calc(100rem + 22vw)' },
      mobile: { top: '196rem', right: '45.79vw' },
    },
    {
      content: 'Spring 프레임 워크',
      ...blueStyle,
      desktop: { top: '282.28rem', right: '10.83vw' },
      tablet: { top: '389rem', right: '23vw' },
      mobile: { top: '235rem', right: '25.7vw' },
    },
  ],
};
